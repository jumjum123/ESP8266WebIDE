chrome.app.runtime.onLaunched.addListener(function(launchData) {
  chrome.app.window.create('main.html', {
    ...
    if (launchData.id) {
      ...
      if (launchData.id === 'LUA_code') {
       if (win.contentWindow.LUA!==undefined && win.contentWindow.LUA.initialised==true) {
          win.contentWindow.LUA.Plugins.URLHandler.handle(launchData.url);
        } else {
